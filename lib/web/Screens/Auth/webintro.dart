...
class webintrologin extends StatelessWidget {
  const webintrologin({super.key});
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Align(alignment: Alignment.topLeft,
                child: Padding(padding: EdgeInsets.only(left: MediaQuery.of(context).size.width > 768 ? 150 : 10),
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Você está na lista!',
                        style:GoogleFonts.poppins(
                          fontSize: MediaQuery.of(context).size.width < 768 ? 20 : 30,
                      ...
                      Text('Agora você está na nossa lista de espera fique',
                        style: GoogleFonts.inter(
                          fontSize: MediaQuery.of(context).size.width < 768 ? 15 : 20,
