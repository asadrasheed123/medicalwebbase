...
class phonetokenlogin extends StatelessWidget {
  const phonetokenlogin({Key? key}) : super(key: key);
            ...
            children: [
              ...
              GestureDetector(onTap: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => phonetokenverification()),
                );
              ...
              SizedBox(height: 30,),
              Container(
                height: 50,width: 300,decoration: BoxDecoration(border: Border.all(color: Color(0xFF5F7686))
                  ,borderRadius: BorderRadius.circular(10)),
